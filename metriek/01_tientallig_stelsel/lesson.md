...
In ons tientallig stelsel heeft **elke positie** een waarde die een macht van 10 is.

## Het getal 2345,678

Kijk naar elk cijfer en zijn plaatswaarde:
...
<div id="fase1-oefen" style="background: #f8fafc; border-radius: 12px; padding: 20px; margin-top: 20px;">
  ...
  <div id="f1-klaar" style="display: none; text-align: center; padding: 20px; background: #dcfce7; border-radius: 10px; margin-top: 12px;">
    ...
    <p style="color: #166534;">Beantwoord nu de vragen hieronder om de module af te ronden.</p>
  </div>
</div>
